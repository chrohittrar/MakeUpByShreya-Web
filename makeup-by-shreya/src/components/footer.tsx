  ...
  return (
    <footer className="backdrop-blur-lg bg-gray-100">
      <div className="relative z-10 max-w-7xl mx-auto px-6 py-10">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-[#5D5D5D]">
          {/* Brand */}
          <div>
            <img
              src={logo}
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              >
                <svg className="w-5 h-5 fill-[#5D5D5D]" viewBox="0 0 24 24">
        ...
        {/* Bottom Line */}
        <div className="mt-10 pt-4 border-t border-white/30 text-center text-sm text-[#5D5D5D]">
          © {new Date().getFullYear()} Make Up By Shreya. All rights reserved.
        </div>
        <div className="mt-1 pt-4 border-t border-white/30 text-center text-sm text-[#5D5D5D]">
